...
import { FiArrowRight, FiBarChart2, FiDroplet, FiTruck, FiSun, FiMoon } from 'react-icons/fi';

function EngenhariaAgropecuaria() {
  ...
  const courseData = {
    hero: {
      title: "Engenharia Agropecuária: Tecnologia no Campo",
      subtitle: "Combine conhecimentos de engenharia com agricultura e pecuária para modernizar o agronegócio.",
      cta: "Quero fazer parte",
      stats: [
        { value: "94%", label: "Empregabilidade" },
        { value: "4.5", label: "Avaliação dos alunos" },
        { value: "20+", label: "Fazendas parceiras" }
      ]
    },
    features: [
      {
        title: "Agricultura de Precisão",
        description: "Tecnologias para otimização da produção agrícola com eficiência de recursos.",
        icon: <FiBarChart2 size={24} />
      },
      {
        title: "Irrigação e Drenagem",
        description: "Projeto de sistemas eficientes de manejo hídrico para propriedades rurais.",
        icon: <FiDroplet size={24} />
      },
      {
        title: "Mecanização Agrícola",
        description: "Seleção e operação de máquinas e equipamentos para o campo.",
        icon: <FiTruck size={24} />
      }
    ],
    specializations: {
      title: "Áreas de Especialização em Engenharia Agropecuária",
      tabs: [
        {
          id: 'precision',
          label: 'Agricultura de Precisão',
          content: 'Uso de tecnologias como drones, sensores e IoT para agricultura eficiente.',
          courses: ['Sensoriamento Remoto', 'GIS', 'Manejo de Dados']
        },
        {
          id: 'irrigation',
          label: 'Irrigação e Recursos Hídricos',
          content: 'Projeto e gestão de sistemas de irrigação para diferentes cultivos.',
          courses: ['Hidráulica Agrícola', 'Manejo de Bacias', 'Sistemas de Irrigação']
        },
        {
          id: 'postharvest',
          label: 'Pós-Colheita e Armazenamento',
          content: 'Técnicas e tecnologias para conservação e processamento de produtos agrícolas.',
          courses: ['Armazenamento de Grãos', 'Tecnologia Pós-Colheita', 'Logística Agrícola']
        }
      ]
    },
    testimonials: [
      {
        quote: "Apliquei os conhecimentos do curso para modernizar a produção na fazenda da minha família.",
        author: "Roberto Fernandes",
        role: "Produtor Rural"
      },
      {
        quote: "O foco em agricultura de precisão me destacou no mercado de trabalho.",
...
export default EngenhariaAgropecuaria;