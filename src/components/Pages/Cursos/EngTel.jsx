...
import { FiArrowRight, FiWifi, FiRadio, FiServer, FiSun, FiMoon } from 'react-icons/fi';

function EngenhariaTelecomunicacoes() {
  ...
  const courseData = {
    hero: {
      title: "Engenharia de Telecomunicações: Conectando o Futuro",
      subtitle: "Formação completa em tecnologias de comunicação para projetar e implementar redes de última geração.",
      cta: "Quero fazer parte",
      stats: [
        { value: "97%", label: "Empregabilidade" },
        { value: "4.6", label: "Avaliação dos alunos" },
        { value: "30+", label: "Parcerias com operadoras" }
      ]
    },
    features: [
      {
        title: "Redes de Telecomunicações",
        description: "Projeto e implementação de redes de comunicação de voz, dados e vídeo.",
        icon: <FiWifi size={24} />
      },
      {
        title: "Sistemas de Transmissão",
        description: "Tecnologias para transmissão via rádio, fibra óptica e satélite.",
        icon: <FiRadio size={24} />
      },
      {
        title: "Comunicação de Dados",
        description: "Protocolos e arquiteturas para comunicação eficiente de grandes volumes de dados.",
        icon: <FiServer size={24} />
      }
    ],
    specializations: {
      title: "Áreas de Especialização em Telecomunicações",
      tabs: [
        {
          id: 'wireless',
          label: 'Comunicações Sem Fio',
          content: 'Projeto e otimização de redes móveis e sistemas de comunicação wireless.',
          courses: ['5G', 'WiMAX', 'Redes Celulares']
        },
        {
          id: 'optical',
          label: 'Redes Ópticas',
          content: 'Tecnologias de transmissão por fibra óptica para alta capacidade.',
          courses: ['DWDM', 'FTTH', 'Redes Ópticas']
        },
        {
          id: 'satellite',
          label: 'Comunicações por Satélite',
          content: 'Sistemas de comunicação via satélite para aplicações diversas.',
          courses: ['VSAT', 'Comunicações Espaciais', 'Sistemas de Satélite']
        }
      ]
    },
    testimonials: [
      {
        quote: "O curso me deu base técnica para trabalhar na implementação da rede 5G no país.",
        author: "Carlos Mendes",
        role: "Engenheiro na Nokia"
      },
      {
        quote: "As parcerias com operadoras me proporcionaram experiência prática valiosa.",
        author: "Juliana Santos",
        role: "Especialista em Redes Ópticas"
      }
    ]
  };
...
export default EngenhariaTelecomunicacoes;